    ...
    !function webpackUniversalModuleDefinition(e, t) {
      ...
      return function(e2) {
        ...
        return __webpack_require__.m = e2, __webpack_require__.c = t2, __webpack_require__.d = function(e3, t3, n) {
          ...
          if (1 & t3 && (e3 = __webpack_require__(e3)), 8 & t3)
            return e3;
          if (4 & t3 && "object" == typeof e3 && e3 && e3.__esModule)
            return e3;
          var n = /* @__PURE__ */ Object.create(null);
          if (__webpack_require__.r(n), Object.defineProperty(n, "default", { enumerable: true, value: e3 }), 2 & t3 && "string" != typeof e3)
            for (var o in e3)
              __webpack_require__.d(n, o, function(t4) {
                return e3[t4];
              }.bind(null, o));
          return n;
        ...
        function classToModules() {
          ...
          if (!t3)
            return e3.join(" ").trim();
          for (var n2 = [], o2 = e3.length; o2--; )
            t3[e3[o2]] && n2.push(t3[e3[o2]]);
          return n2;
        }
        ...
        function _toConsumableArray(e3) {
          return function _arrayWithoutHoles(e4) {
            if (Array.isArray(e4)) {
              for (var t3 = 0, n2 = new Array(e4.length); t3 < e4.length; t3++)
                n2[t3] = e4[t3];
              return n2;
            }
        ...
        var r = function classListAdd(e3, t3) {
          ...
          for (var n2 = _objectSpread({}, t3[0]), o2 = 1; o2 < t3.length; o2 += 1) {
            for (var r2 in n2)
              t3[o2][r2] && (n2[r2] = [n2[r2], t3[o2][r2]].join(" "));
            for (var i2 in t3[o2])
              n2[i2] || (n2[i2] = t3[o2][i2]);
          }
          return n2;
        };
        ...
        e2.exports = function(e3) {
          ...
          return t3.m = e3, t3.c = n2, t3.d = function(e4, n3, o) {
            ...
            if (1 & n3 && (e4 = t3(e4)), 8 & n3)
              return e4;
            if (4 & n3 && "object" == typeof e4 && e4 && e4.__esModule)
              return e4;
            var o = /* @__PURE__ */ Object.create(null);
            if (t3.r(o), Object.defineProperty(o, "default", { enumerable: true, value: e4 }), 2 & n3 && "string" != typeof e4)
              for (var r in e4)
                t3.d(o, r, function(t4) {
                  return e4[t4];
                }.bind(null, r));
            return o;
          }, t3.n = function(e4) {
        ...
        function _objectWithoutProperties(e3, t3) {
          ...
          var n2, o2, r2 = function _objectWithoutPropertiesLoose(e4, t4) {
            ...
            for (o3 = 0; o3 < i3.length; o3++)
              n3 = i3[o3], t4.indexOf(n3) >= 0 || (r3[n3] = e4[n3]);
            return r3;
          }(e3, t3);
          if (Object.getOwnPropertySymbols) {
            var i2 = Object.getOwnPropertySymbols(e3);
            for (o2 = 0; o2 < i2.length; o2++)
              n2 = i2[o2], t3.indexOf(n2) >= 0 || Object.prototype.propertyIsEnumerable.call(e3, n2) && (r2[n2] = e3[n2]);
          }
          return r2;
        }
        ...
        var f = function(e3) {
          function Media() {
            ...
            for (var n2 = arguments.length, o2 = new Array(n2), r2 = 0; r2 < n2; r2++)
              o2[r2] = arguments[r2];
        ...
        var p = "awssld", b = new c.a(), h = function(e3) {
          ...
          return function core_inherits(e4, t3) {
            ...
            if (this.checkChildren(e4), this.setupClassNames(Object(l.e)(e4.cssModule)), e4.name === this.props.name)
              if (true !== e4.startup || false !== this.started)
                if (e4.selected === this.props.selected)
                  this.refreshSlider();
                else {
